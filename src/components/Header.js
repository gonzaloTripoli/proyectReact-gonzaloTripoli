...
const Footer = () => {
  return (
    ...
    <>
      <div class="grid grid-cols-12 grid-rows-3 h-28  place-items-center bg-borderBlackNew font-medium use border-4 border-b-borderBlackNew rounded-full shadow-2xl">
        <Navbar />
